...
public class updateProfile extends JFrame implements MouseListener, ActionListener{
    JPanel panel;
    JLabel userLabel, genderLabel, dobLabel, addressLabel,customerbagg;
    ...
    public updateProfile(user u, users us, dashBoard db, login lg){
       ...
       // userTF.setForeground(Color.BLACK);
        ...
        clearBtn.setBounds(411,481,150,30);
        ...
        updateBtn.setBounds(575,481,150,30);
        ...
        panel.add(backBtn);
        ////////////////////////////////BACKGROUND IMAGE///////////
        customericon222 = new ImageIcon("images\\bg2.jpg");
        customerbagg =new JLabel(customericon222);
        customerbagg.setBounds(0,0,1366,768);
